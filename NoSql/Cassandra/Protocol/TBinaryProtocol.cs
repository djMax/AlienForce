...
namespace Thrift.Protocol
{
	public class TBinaryProtocol : TProtocol
	{
		...
		public static byte[] ToNetwork(short s)
		{
			var li16out= new byte[2];
			li16out[0] = (byte)(0xff & (s >> 8));
			li16out[1] = (byte)(0xff & s);
			return li16out;
		}
		...
		public static byte[] ToNetwork(int i32)
		{
			var li32out = new byte[4];
			li32out[0] = (byte)(0xff & (i32 >> 24));
			li32out[1] = (byte)(0xff & (i32 >> 16));
			li32out[2] = (byte)(0xff & (i32 >> 8));
			li32out[3] = (byte)(0xff & i32);
			return li32out;
		}
		...
		public static byte[] ToNetwork(long i64)
		{
			var li64out = new byte[8];
			li64out[0] = (byte)(0xff & (i64 >> 56));
			li64out[1] = (byte)(0xff & (i64 >> 48));
			li64out[2] = (byte)(0xff & (i64 >> 40));
			li64out[3] = (byte)(0xff & (i64 >> 32));
			li64out[4] = (byte)(0xff & (i64 >> 24));
			li64out[5] = (byte)(0xff & (i64 >> 16));
			li64out[6] = (byte)(0xff & (i64 >> 8));
			li64out[7] = (byte)(0xff & i64);
			return li64out;
		}
		...
		public static short ReadI16(byte[] b, int offset)
		{
		...
		public static int ReadI32(byte[] b, int offset)
		{
